...
@Override public long getStatSize(){ if (!testjnOverride( "getStatSize" )) return super.getStatSize(); return (java.lang.Long) jInterface.Jnido( this, jchildidx + "getStatSize_" + jlocale + "_", null ); }
