...
public class FaceDetector extends android.media.FaceDetector{
...
@Override public int findFaces(android.graphics.Bitmap arg1,android.media.FaceDetector.Face[] arg2) { if (!testjnOverride( "findFaces" )) return super.findFaces( arg1, arg2); return (java.lang.Integer) jInterface.Jnido( this, jchildidx + "findFaces_" + jlocale + "_", new java.lang.Object[]{ arg1, arg2 } ); }
}
