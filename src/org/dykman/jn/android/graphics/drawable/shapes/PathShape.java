...
public class PathShape extends android.graphics.drawable.shapes.PathShape{
...
@Override public android.graphics.drawable.shapes.PathShape clone() throws java.lang.CloneNotSupportedException{ if (!testjnOverride( "clone" )) return super.clone(); return (android.graphics.drawable.shapes.PathShape) jInterface.Jnido( this, jchildidx + "clone_" + jlocale + "_", null ); }
