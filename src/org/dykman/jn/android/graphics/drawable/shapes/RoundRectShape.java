...
public class RoundRectShape extends android.graphics.drawable.shapes.RoundRectShape{
...
public RoundRectShape(float[] arg1,android.graphics.RectF arg2,float[] arg3, java.lang.String jlocale,String jchildid,String joverride ) { super( arg1, arg2, arg3); jnOverrideList = new java.util.ArrayList(); jparseargs( jlocale, jchildid, joverride ); jInterface = org.dykman.j.android.JConsoleApp.theApp.jInterface; if (testjnOverride( "jcreate" )) jInterface.Jnido( this, jchildidx + "jcreate_" + jlocale + "_", new java.lang.Object[]{ arg1, arg2, arg3 } ); }
@Override public android.graphics.drawable.shapes.RoundRectShape clone() throws java.lang.CloneNotSupportedException{ if (!testjnOverride( "clone" )) return super.clone(); return (android.graphics.drawable.shapes.RoundRectShape) jInterface.Jnido( this, jchildidx + "clone_" + jlocale + "_", null ); }
