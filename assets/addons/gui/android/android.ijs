...
StartActivity=: 4 : 0
'act ctx locale override japparg'=. 5{.y
assert. *#locale
...
if. 'Android'-:UNAME do.
  try.
    APILEVEL=: ('SDK_INT I' jniStaticField) 'android.os.Build$VERSION'
  catch.
    ExceptionClear''
    APILEVEL=: 3
  end.
...
if. 'Android'-:UNAME do.
  ...
  for_a. }.l do.
    try.
      if. 4=x do.
        ". p, (>a), '=: (''', (>a), ' I'' jniStaticField) ''', class, ''''
      else.
        ". p, (>a), '=: (''', (>a), ' F'' jniStaticField) ''', class, ''''
      end.
    catch.
      ExceptionClear''
    end.
...
gravityconst=: 16b30 16b50 16b03 16b05 16b10 16b70 16b01 16b07 16b11 16b77 16b80 16b08 16b00800003 16b00800005
gravityattr=: <;.1 ' top bottom left right center_vertical fill_vertical center_horizontal fill_horizontal center fill clip_vertical clip_horizontal start end'

androidcolorconst=: _16777216 _16776961 _16711681 _12303292 _7829368 _16711936 _3355444 _65281 _65536 0 _1 _256
...
elseif. y-:'false' do.
  0
elseif. '?android:attr/'-:14{.y do.
  {. 0+". 'R_attr_',(14}.y),'_jarattr_'
elseif. '@attr/'-:6{.y do.
  f0=. ({."1 res) = <'attr'
  f1=. (1{"1 res) = <6}.y
  if. #f=. I. f0*.f1 do.
...
for_i. i.#elements do.
  ...
  if. (*#attval) +. (<elm) e. <;._1 ' AbsoluteLayout AnalogClock Button CheckBox DatePicker DigitalClock EditText FrameLayout Gallery ImageButton ImageView LinearLayout ListView ProgressBar RadioButton RadioGroup RelativeLayout ScrollView Spinner TableLayout TableRow TextView TimePicker' do.
    ...
    if. (*#rule,rule2) +. (0 e. 0=margin) +. (0 e. WRAP_CONTENT=wh) +. (0~:gravity) +. (0~:weight) +. (_1~:column) +. (1~:span) do.
      ...
      lp=. (lpclass, ' II') jniNewObject~ <"0 wh
