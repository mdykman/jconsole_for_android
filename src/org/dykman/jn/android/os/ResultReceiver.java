...
public ResultReceiver(android.os.Handler arg1, java.lang.String jlocale,String jchildid,String joverride ) { super( arg1); jnOverrideList = new java.util.ArrayList(); jparseargs( jlocale, jchildid, joverride ); jInterface = org.dykman.j.android.JConsoleApp.theApp.jInterface; if (testjnOverride( "jcreate" )) jInterface.Jnido( this, jchildidx + "jcreate_" + jlocale + "_", new java.lang.Object[]{ arg1 } ); }
@Override public void send(int arg1,android.os.Bundle arg2) { if (!testjnOverride( "send" )) { super.send( arg1, arg2); return; } jInterface.Jnido( this, jchildidx + "send_" + jlocale + "_", new java.lang.Object[]{ arg1, arg2 } ); }
@Override protected void onReceiveResult(int arg1,android.os.Bundle arg2) { if (!testjnOverride( "onReceiveResult" )) { super.onReceiveResult( arg1, arg2); return; } jInterface.Jnido( this, jchildidx + "onReceiveResult_" + jlocale + "_", new java.lang.Object[]{ arg1, arg2 } ); }
