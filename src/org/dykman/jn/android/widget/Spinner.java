...
@Override public void setPrompt(java.lang.CharSequence arg1) { if (!testjnOverride( "setPrompt" )) { super.setPrompt( arg1); return; } jInterface.Jnido( this, jchildidx + "setPrompt_" + jlocale + "_", new java.lang.Object[]{ arg1 } ); }
@Override public void setPromptId(int arg1) { if (!testjnOverride( "setPromptId" )) { super.setPromptId( arg1); return; } jInterface.Jnido( this, jchildidx + "setPromptId_" + jlocale + "_", new java.lang.Object[]{ arg1 } ); }
@Override public java.lang.CharSequence getPrompt(){ if (!testjnOverride( "getPrompt" )) return super.getPrompt(); return (java.lang.CharSequence) jInterface.Jnido( this, jchildidx + "getPrompt_" + jlocale + "_", null ); }
}
