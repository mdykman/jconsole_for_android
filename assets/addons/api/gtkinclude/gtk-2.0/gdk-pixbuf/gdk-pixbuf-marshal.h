...
/* VOID:VOID (/scratch/build-area/gtk+2.0-2.20.1/gdk-pixbuf/gdk-pixbuf-marshal.list:25) */
#define _gdk_pixbuf_marshal_VOID__VOID	g_cclosure_marshal_VOID__VOID

/* VOID:INT,INT (/scratch/build-area/gtk+2.0-2.20.1/gdk-pixbuf/gdk-pixbuf-marshal.list:26) */
...
/* VOID:INT,INT,INT,INT (/scratch/build-area/gtk+2.0-2.20.1/gdk-pixbuf/gdk-pixbuf-marshal.list:27) */
...
/* VOID:POINTER (/scratch/build-area/gtk+2.0-2.20.1/gdk-pixbuf/gdk-pixbuf-marshal.list:28) */
